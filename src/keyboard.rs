...
use windows::Win32::UI::WindowsAndMessaging::{
    CallNextHookEx, SetWindowsHookA, HHOOK, KBDLLHOOKSTRUCT, WH_KEYBOARD_LL, WM_KEYDOWN, WM_KEYUP,
...
pub fn monitor_keyboard() {
    ...
    unsafe {
        let _ = SetWindowsHookA(WH_KEYBOARD_LL.0, Some(kbd_hook));
    }
}
...
pub fn get_key_mapping(key: VIRTUAL_KEY) -> Option<String> {
    match key {
        ...
        VK_Enter => Some("Enter".into()),
        VK_SHIFT => Some("Shift".into()),
        VK_CONTROL => Some("Ctrl".into()),
        VK_Alt => Some("Alt".into()),
        VK_Backspace => Some("Backspace".into()),
        ...
        VK_CapsLock => Some("CapsLock".into()),
        _ => None, // 不处理其他键
    }
}
